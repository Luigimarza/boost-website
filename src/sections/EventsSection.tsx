      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
        {items.map((item, i) => (
          <motion.div
            ...
            whileHover={{ y: -8 }}
            className="relative rounded-[24px] sm:rounded-[32px] md:rounded-[40px] overflow-hidden border-2 border-[#D7E2EA]/30 hover:border-[#f1552d] transition-colors duration-300 group"
