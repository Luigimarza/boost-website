...
export default function ContactFormSection() {
  ...
  const inputClass =
    'w-full bg-transparent border-b border-[#D7E2EA]/40 text-[#D7E2EA] placeholder-[#D7E2EA]/40 py-3 px-1 text-base sm:text-lg outline-none transition-colors duration-300 focus:border-[#f1552d]';
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <FadeIn delay={0.1} y={20}>
          <p
            className="text-[#D7E2EA]/80 text-center mt-6 mb-12 sm:mb-16 md:mb-20"
        ...
        >
          <div>
            <label className="text-[#D7E2EA]/60 text-xs uppercase tracking-widest">
          ...
          <div className="sm:col-span-2">
            ...
            >
              <option value="" disabled className="bg-[#0C0C0C] text-[#D7E2EA]/50">
                {t.contactForm.needPlaceholder}
              </option>
              {t.services.list.map((s) => (
                <option key={s.n} value={s.name} className="bg-[#0C0C0C] text-[#D7E2EA]">
                  {s.name}
                </option>
              ))}
            </select>
          ...
          <div className="sm:col-span-2 flex flex-col items-center gap-4 mt-4">
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-full text-white font-medium uppercase tracking-widest px-10 py-4 sm:px-14 sm:py-4 text-sm sm:text-base transition-transform duration-300 hover:scale-[1.04]"
              style={{
                background:
            ...
            {sent && (
              <p className="text-[#f1552d] text-sm uppercase tracking-widest">{t.contactForm.success}</p>
            )}
          </div>
        </motion.form>
      </div>
